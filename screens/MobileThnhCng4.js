    ...
    <View style={styles.mobileThnhCng}>
      ...
      <View style={[styles.mobileLpHc, styles.mobileLayout]}>
        ...
        >
          <Image
            style={[styles.icon1, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../assets/3-icon41.png")}
          />
        </Pressable>
        <Pressable
        ...
        >
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/icon241.png")}
          />
        </Pressable>
        <Pressable
        ...
        >
          <Image
            style={[styles.icon1, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../assets/2-icon71.png")}
          />
        </Pressable>
        <Pressable
        ...
        >
          <Image
            style={[styles.icon1, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../assets/2-icon81.png")}
          />
        </Pressable>
        <View style={[styles.icon10, styles.lp9APosition]}>
          <Image
            style={styles.iconLayout}
            resizeMode="cover"
            source={require("../assets/icon251.png")}
          />
      ...
      <View style={[styles.mobileLpHc2, styles.mobileLayout]}>
        ...
        >
          <Image
            style={[styles.icon1, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../assets/3-icon51.png")}
          />
        </Pressable>
        <Pressable
          style={[styles.icon4, styles.iconFlexBox]}
        ...
        >
          <Image
            style={[styles.icon1, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../assets/2-icon91.png")}
          />
        </Pressable>
        <View style={[styles.icon10, styles.lp9APosition]}>
          <Image
      ...
      <View style={styles.modal}>
        ...
        <View style={styles.titleParent}>
          ...
          <Text style={styles.vnHcNghTypo}>
            {`Bạn đã sao chép mã liên kết lớp `}thành công
          </Text>
        </View>
      </View>
    </View>
