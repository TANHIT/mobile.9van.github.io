...
const MobileKtThcLpThnhCng = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.mobileKtThcLpThnhCng}>
      ...
      <View style={styles.modal}>
        ...
        <View style={styles.titleParent}>
          ...
          <Text style={styles.vnHcNghTypo}>Bạn đã kết thúc lớp học</Text>
        </View>
      </View>
    </View>
  );
...
export default MobileKtThcLpThnhCng;
