      ...
      <View style={[styles.chnhSaBi, styles.modalPosition1]}>
        <View style={[styles.modal, styles.modalPosition]}>
          ...
          <View style={[styles.footer, styles.footerPosition]}>
            <Pressable
              style={[styles.buttonParent, styles.icon10Layout]}
              onPress={() => navigation.navigate("MobileThnhCng7")}
            >
              <Pressable
              ...
              <View style={[styles.button1, styles.buttonLayout]}>
                <Text style={[styles.label16, styles.labelLayout1]}>Tạo</Text>
              </View>
            </Pressable>
          </View>
          <View style={styles.titleParent}>
            <Text style={[styles.title, styles.labelTypo2]}>Tạo đề bài</Text>
