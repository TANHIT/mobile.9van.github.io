...
const MobileGiao1 = () => {
  ...
  return (
    <View style={styles.mobileGiao}>
      <View style={[styles.component2, styles.fillPosition1]}>
      ...
      <View style={[styles.mobileThanhTmKim, styles.mobileParentFlexBox]}>
        <Text style={[styles.lpHc1, styles.labelClr]}>Luyện đề chung</Text>
        ...
        <View style={[styles.modalParent, styles.rectangleParentPosition]}>
          <View style={[styles.modalParent, styles.rectangleParentPosition]}>
            ...
            <View style={[styles.footer, styles.footerPosition]}>
              <View style={[styles.buttonParent, styles.icon10Layout]}>
                <Pressable
                ...
                <Pressable
                  ...
                  onPress={() => navigation.navigate("MobileThnhCng6")}
                >
          ...
          <View style={[styles.dateInput, styles.inputPosition]}>
            ...
            <View style={[styles.dropdown3, styles.footerPosition]}>
              ...
              <Image
                style={[styles.icon11, styles.iconPosition1]}
                resizeMode="cover"
