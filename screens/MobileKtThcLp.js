...
const MobileKtThcLp = () => {
  ...
  return (
    <View style={styles.mobileKtThcLp}>
      ...
      <View style={styles.modal}>
        <View style={styles.fillPosition}>
          <Image
            style={[styles.fillIcon, styles.footerLayout]}
            resizeMode="cover"
            source={require("../assets/fill71.png")}
          />
          <Pressable
        ...
        <View style={[styles.footer, styles.footerLayout]}>
          <Pressable
            style={[styles.buttonParent, styles.icon35Layout]}
            onPress={() => navigation.navigate("MobileKtThcLpThnhCng")}
          >
            <Pressable
        ...
        <View style={styles.titleParent}>
          <Text style={[styles.title, styles.titleClr]}>Kết thúc lớp học</Text>
          <Text style={[styles.subtitle, styles.titleClr]}>
            {`Sau khi kết thúc lớp học thành viên `}
            {`trong lớp có thể xem lại kết quả học `}
            {`tập của lớp học `}
          </Text>
        </View>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/icon261.png")}
        />
      </View>
    </View>
  );
