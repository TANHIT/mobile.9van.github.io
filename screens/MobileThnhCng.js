    ...
    <View style={styles.mobileThnhCng}>
      ...
      <View style={[styles.mobileThanhTmKim, styles.mobileParentFlexBox]}>
        ...
        <View style={styles.input}>
          ...
          <Text style={[styles.placeholder, styles.icon12Position]}>
            Tìm kiếm
          </Text>
          <Image
      ...
      <View style={styles.modal}>
        <View style={[styles.modal1, styles.modal1Position]}>
          ...
          />
          <Pressable
            style={[styles.icon10, styles.iconFlexBox]}
            onPress={() => navigation.navigate("MobileBiCaTi")}
          >
            <Image
              style={styles.iconLayout}
        ...
        <View style={styles.titleParent}>
          ...
          <Text style={styles.label8Typo}>Bạn đã hoàn thành việc đề bài</Text>
        </View>
      </View>
    </View>
  );
